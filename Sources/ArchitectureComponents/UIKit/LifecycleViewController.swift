...
open class LifecycleViewController: UIViewController, LifecycleOwner {
    ...
    private func registerForNotifications() {
        ...
        center.addObserver(
            self,
            selector: #selector(LifecycleViewController.handleApplicationStateChangeNotification(_:)),
